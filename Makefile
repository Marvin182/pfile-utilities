...
AC_FLAGS =		-DPACKAGE_NAME=\"pfile_utils\" -DPACKAGE_TARNAME=\"pfile_utils\" -DPACKAGE_VERSION=\"v0_51\" -DPACKAGE_STRING=\"pfile_utils\ v0_51\" -DPACKAGE_BUGREPORT=\"quicknet-bugs@icsi.berkeley.edu\" -DHAVE_BOOL=1 -D_FILE_OFFSET_BITS=64 -DHAVE_FSEEKO=1 -DHAVE_SIGSET=1 
srcdir =		.
...
IFLAGS		=	-I$(srcdir) -g -O2 -I/usr/local/include/quicknet3  

LIBS		=	-L/usr/local/lib -lquicknet3 -lpthread -lm   
